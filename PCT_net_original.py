...
class Featurer(nn.Module):
    def __init__(self, add_axis=1):
        ...
        self.up_conv_1 = nn.Conv2d(16, 32, kernel_size=(3, 3), padding=(1, 1))

        self.conv_block_2 = ConvBlock(channels_in=32, channels_out=32)
        self.up_conv_2 = nn.Conv2d(32, 64, kernel_size=(3, 3), padding=(1, 1))
    ...
    def forward(self, x):
        ...
        c = self.up_conv_1(self.conv_block_1(x) + x)
        c = self.up_conv_2(self.conv_block_2(c) + c)
